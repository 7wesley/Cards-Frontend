        ...
        {/* <div>
            ...
            <div className="d-flex flex-column min-vh-100 justify-content-center align-items-center">
                <div className="text-center ">
                    ...
                    <Link onClick={props.modifyState} to="login" className="btn btn-primary btn-lg mr-2">
                        Login
                    </Link>
                    <Link onClick={props.modifyState} to="games" className="btn btn-primary btn-lg ml-2">
                        Guest
                    </Link>
